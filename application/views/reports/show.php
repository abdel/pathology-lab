	...
	<div class="panel-heading">
        ...
        <div class="pull-right">
			<div class="btn btn-default">
			  	<?php echo anchor('reports/show/'.$report->id.'/pdf', '<span class="glyphicon glyphicon-cloud-download" aria-hidden="true"></span> Export as PDF'); ?>
			</div>
			<div class="btn btn-default">
			  	<?php echo anchor('reports/show/'.$report->id.'/mail', '<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Mail as PDF'); ?>
			</div>
		</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
        ...
        <div class="panel panel-default">
        	<div class="panel-heading">
				<h3 class="panel-title "><strong><?php echo $test->name; ?></strong></h3>
			</div>
			<div class="panel-body">
